...
<?php if (strlen ( $this->_tpl_vars['fields']['enquire_supplier_id_c']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['enquire_supplier_id_c']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['enquire_supplier_id_c']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['enquire_supplier_id_c']['name']; ?>
' 
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='enquire_vendor_item_c_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_ENQUIRE_VENDOR_ITEM','module' => 'Opportunities'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php if (strlen ( $this->_tpl_vars['fields']['enquire_vendor_item_c']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['enquire_vendor_item_c']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['enquire_vendor_item_c']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['enquire_vendor_item_c']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['enquire_vendor_item_c']['name']; ?>
' size='30' 
maxlength='255' 
value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
<td valign="top" id='enquire_state_c_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_ENQUIRE_STATE','module' => 'Opportunities'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php if (strlen ( $this->_tpl_vars['fields']['enquire_state_c']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['enquire_state_c']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['enquire_state_c']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['enquire_state_c']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['enquire_state_c']['name']; ?>
' size='30' 
maxlength='255' 
value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
addToValidateRange(\'EditView\', \'opportunity_autoincrement_id_c\', \'int\', false, \'';  echo smarty_function_sugar_translate(array('label' => 'LBL_OPPORTUNITY_AUTOINCREMENT_ID','module' => 'Opportunities','for_js' => true), $this); echo '\', 1501, 1599);
addToValidate(\'EditView\', \'enquire_supplier_id_c\', \'int\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ENQUIRE_SUPPLIER_ID','module' => 'Opportunities','for_js' => true), $this); echo '\' );
