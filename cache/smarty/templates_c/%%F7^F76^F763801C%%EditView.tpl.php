...
<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>
<input type="hidden" id="<?php echo $this->_tpl_vars['fields']['company_type_multi_c']['name']; ?>
_multiselect"
name="<?php echo $this->_tpl_vars['fields']['company_type_multi_c']['name']; ?>
_multiselect" value="true">
<?php echo smarty_function_multienum_to_array(array('string' => $this->_tpl_vars['fields']['company_type_multi_c']['value'],'default' => $this->_tpl_vars['fields']['company_type_multi_c']['default'],'assign' => 'values'), $this);?>

<select id="<?php echo $this->_tpl_vars['fields']['company_type_multi_c']['name']; ?>
"
name="<?php echo $this->_tpl_vars['fields']['company_type_multi_c']['name']; ?>
[]"
multiple="true" size='6' style="width:150" title='' tabindex="0"  
>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['company_type_multi_c']['options'],'selected' => $this->_tpl_vars['values']), $this);?>

</select>
<?php else:  $this->assign('field_options', $this->_tpl_vars['fields']['company_type_multi_c']['options']);  ob_start();  echo $this->_tpl_vars['fields']['company_type_multi_c']['value'];  $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean();  $this->assign('field_val', $this->_smarty_vars['capture']['field_val']);  ob_start();  echo $this->_tpl_vars['fields']['company_type_multi_c']['name'];  $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean();  $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<input type="hidden" id="<?php echo $this->_tpl_vars['fields']['company_type_multi_c']['name']; ?>
_multiselect"
name="<?php echo $this->_tpl_vars['fields']['company_type_multi_c']['name']; ?>
_multiselect" value="true">
...
<select style='display:none' id="<?php echo $this->_tpl_vars['fields']['company_type_multi_c']['name']; ?>
"
name="<?php echo $this->_tpl_vars['fields']['company_type_multi_c']['name']; ?>
[]"
multiple="true" size='6' style="width:150" title='' tabindex="0"  
...
<input
id="<?php echo $this->_tpl_vars['fields']['company_type_multi_c']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['company_type_multi_c']['name']; ?>
-input"
size="60"
...
<button type="button"
id="btn-clear-<?php echo $this->_tpl_vars['fields']['company_type_multi_c']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['company_type_multi_c']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['company_type_multi_c']['name']; ?>
;');SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
...
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.ds = new Y.DataSource.Function({
source: function (request) {
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['company_type_multi_c']['name'];  echo '");
var ret = [];
for (i=0;i<selectElem.options.length;i++)
if (!(selectElem.options[i].value==\'\' && selectElem.options[i].innerHTML==\'\'))
ret.push({\'key\':selectElem.options[i].value,\'text\':selectElem.options[i].innerHTML});
...
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['company_type_multi_c']['name']; ?>
-input');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['company_type_multi_c']['name']; ?>
-image');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['company_type_multi_c']['name']; ?>
');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.minQLen = 0;
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
...
if (document.activeElement != document.getElementById("';  echo $this->_tpl_vars['fields']['company_type_multi_c']['name']; ?>
-input<?php echo '"))
