...
<td valign="top" id='vat_number_c_label' width='12.5%' scope="col">
...
{capture name="tr" assign="tableRow"}
<tr>
<td valign="top" id='billing_address_street_2_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_BILLING_ADDRESS_STREET_2' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.billing_address_street_2_c.value) <= 0}
{assign var="value" value=$fields.billing_address_street_2_c.default_value }
{else}
{assign var="value" value=$fields.billing_address_street_2_c.value }
{/if}  
<input type='text' name='{$fields.billing_address_street_2_c.name}' 
id='{$fields.billing_address_street_2_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
<td valign="top" id='shipping_address_street_2_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_SHIPPING_ADDRESS_STREET_2' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.shipping_address_street_2_c.value) <= 0}
{assign var="value" value=$fields.shipping_address_street_2_c.default_value }
{else}
{assign var="value" value=$fields.shipping_address_street_2_c.value }
{/if}  
<input type='text' name='{$fields.shipping_address_street_2_c.name}' 
id='{$fields.shipping_address_street_2_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</tr>
{/capture}
...
{capture name="tr" assign="tableRow"}
<tr>
<td valign="top" id='billing_address_street_3_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_BILLING_ADDRESS_STREET_3' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.billing_address_street_3_c.value) <= 0}
{assign var="value" value=$fields.billing_address_street_3_c.default_value }
{else}
{assign var="value" value=$fields.billing_address_street_3_c.value }
{/if}  
<input type='text' name='{$fields.billing_address_street_3_c.name}' 
id='{$fields.billing_address_street_3_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
<td valign="top" id='shipping_address_street_3_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_SHIPPING_ADDRESS_STREET_3' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.shipping_address_street_3_c.value) <= 0}
{assign var="value" value=$fields.shipping_address_street_3_c.default_value }
{else}
{assign var="value" value=$fields.shipping_address_street_3_c.value }
{/if}  
<input type='text' name='{$fields.shipping_address_street_3_c.name}' 
id='{$fields.shipping_address_street_3_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</tr>
{/capture}
...
{capture name="tr" assign="tableRow"}
<tr>
<td valign="top" id='company_type_multi_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_COMPANY_TYPE_MULTI' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<input type="hidden" id="{$fields.company_type_multi_c.name}_multiselect"
name="{$fields.company_type_multi_c.name}_multiselect" value="true">
{multienum_to_array string=$fields.company_type_multi_c.value default=$fields.company_type_multi_c.default assign="values"}
<select id="{$fields.company_type_multi_c.name}"
name="{$fields.company_type_multi_c.name}[]"
multiple="true" size='6' style="width:150" title='' tabindex="0"  
>
{html_options options=$fields.company_type_multi_c.options selected=$values}
</select>
{else}
{assign var="field_options" value=$fields.company_type_multi_c.options }
{capture name="field_val"}{$fields.company_type_multi_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.company_type_multi_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<input type="hidden" id="{$fields.company_type_multi_c.name}_multiselect"
name="{$fields.company_type_multi_c.name}_multiselect" value="true">
{multienum_to_array string=$fields.company_type_multi_c.value default=$fields.company_type_multi_c.default assign="values"}
<select style='display:none' id="{$fields.company_type_multi_c.name}"
name="{$fields.company_type_multi_c.name}[]"
multiple="true" size='6' style="width:150" title='' tabindex="0"  
>
{html_options options=$fields.company_type_multi_c.options selected=$values}
...
<input
id="{$fields.company_type_multi_c.name}-input"
name="{$fields.company_type_multi_c.name}-input"
size="60"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button">
<img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.company_type_multi_c.name}-image">
</button>
<button type="button"
id="btn-clear-{$fields.company_type_multi_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.company_type_multi_c.name}-input', '{$fields.company_type_multi_c.name};');SUGAR.AutoComplete.{$ac_key}.inputNode.updateHidden()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
...
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.ds = new Y.DataSource.Function({
source: function (request) {
var selectElem = document.getElementById("{/literal}{$fields.company_type_multi_c.name}{literal}");
var ret = [];
for (i=0;i<selectElem.options.length;i++)
if (!(selectElem.options[i].value=='' && selectElem.options[i].innerHTML==''))
ret.push({'key':selectElem.options[i].value,'text':selectElem.options[i].innerHTML});
...
{/literal}
SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.company_type_multi_c.name}-input');
SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.company_type_multi_c.name}-image');
SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.company_type_multi_c.name}');
SUGAR.AutoComplete.{$ac_key}.minQLen = 0;
SUGAR.AutoComplete.{$ac_key}.queryDelay = 0;
SUGAR.AutoComplete.{$ac_key}.numOptions = {$field_options|@count};
if(SUGAR.AutoComplete.{$ac_key}.numOptions >= 300) {literal}{
...
if (document.activeElement != document.getElementById("{/literal}{$fields.company_type_multi_c.name}-input{literal}"))
...
{capture name="label" assign="label"}{sugar_translate label='LBL_CHEMSPACE_PARTNER' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.chemspace_partner_c.name}" 
id="{$fields.chemspace_partner_c.name}" 
title=''       
>
{if isset($fields.chemspace_partner_c.value) && $fields.chemspace_partner_c.value != ''}
{html_options options=$fields.chemspace_partner_c.options selected=$fields.chemspace_partner_c.value}
{else}
{html_options options=$fields.chemspace_partner_c.options selected=$fields.chemspace_partner_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.chemspace_partner_c.options }
{capture name="field_val"}{$fields.chemspace_partner_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.chemspace_partner_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.chemspace_partner_c.name}" 
id="{$fields.chemspace_partner_c.name}" 
title=''          
>
{if isset($fields.chemspace_partner_c.value) && $fields.chemspace_partner_c.value != ''}
...
<input
id="{$fields.chemspace_partner_c.name}-input"
name="{$fields.chemspace_partner_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.chemspace_partner_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.chemspace_partner_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.chemspace_partner_c.name}-input', '{$fields.chemspace_partner_c.name}');sync_{$fields.chemspace_partner_c.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
...
{literal}
(function (){
var selectElem = document.getElementById("{/literal}{$fields.chemspace_partner_c.name}{literal}");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:''};
//get default
...
YUI().use("autocomplete", "autocomplete-filters", "autocomplete-highlighters", "node","node-event-simulate", function (Y) {
{/literal}
SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.chemspace_partner_c.name}-input');
SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.chemspace_partner_c.name}-image');
SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.chemspace_partner_c.name}');
{literal}
function SyncToHidden(selectme){
var selectElem = document.getElementById("{/literal}{$fields.chemspace_partner_c.name}{literal}");
var doSimulateChange = false;
...
//global variable 
sync_{/literal}{$fields.chemspace_partner_c.name}{literal} = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("{/literal}{$fields.chemspace_partner_c.name}{literal}");
...
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.simulate('keyup');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.chemspace_partner_c.name}-input{literal}'))
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("{/literal}{$fields.chemspace_partner_c.name}{literal}", syncFromHiddenToWidget);
{/literal}
SUGAR.AutoComplete.{$ac_key}.minQLen = 0;
SUGAR.AutoComplete.{$ac_key}.queryDelay = 0;
SUGAR.AutoComplete.{$ac_key}.numOptions = {$field_options|@count};
...
<td valign="top" id='active_customer_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_ACTIVE_CUSTOMER' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.active_customer_c.name}" 
id="{$fields.active_customer_c.name}" 
title=''       
>
{if isset($fields.active_customer_c.value) && $fields.active_customer_c.value != ''}
{html_options options=$fields.active_customer_c.options selected=$fields.active_customer_c.value}
{else}
{html_options options=$fields.active_customer_c.options selected=$fields.active_customer_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.active_customer_c.options }
{capture name="field_val"}{$fields.active_customer_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.active_customer_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.active_customer_c.name}" 
id="{$fields.active_customer_c.name}" 
title=''          
>
{if isset($fields.active_customer_c.value) && $fields.active_customer_c.value != ''}
...
<input
id="{$fields.active_customer_c.name}-input"
name="{$fields.active_customer_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.active_customer_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.active_customer_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.active_customer_c.name}-input', '{$fields.active_customer_c.name}');sync_{$fields.active_customer_c.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
...
{literal}
(function (){
var selectElem = document.getElementById("{/literal}{$fields.active_customer_c.name}{literal}");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:''};
//get default
...
YUI().use("autocomplete", "autocomplete-filters", "autocomplete-highlighters", "node","node-event-simulate", function (Y) {
{/literal}
SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.active_customer_c.name}-input');
SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.active_customer_c.name}-image');
SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.active_customer_c.name}');
{literal}
function SyncToHidden(selectme){
var selectElem = document.getElementById("{/literal}{$fields.active_customer_c.name}{literal}");
var doSimulateChange = false;
...
//global variable 
sync_{/literal}{$fields.active_customer_c.name}{literal} = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("{/literal}{$fields.active_customer_c.name}{literal}");
...
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.simulate('keyup');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.active_customer_c.name}-input{literal}'))
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("{/literal}{$fields.active_customer_c.name}{literal}", syncFromHiddenToWidget);
{/literal}
SUGAR.AutoComplete.{$ac_key}.minQLen = 0;
SUGAR.AutoComplete.{$ac_key}.queryDelay = 0;
SUGAR.AutoComplete.{$ac_key}.numOptions = {$field_options|@count};
...
addToValidate('EditView', 'shipping_address_street_3_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_SHIPPING_ADDRESS_STREET_3' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'supplier_id_c', 'int', false,'{/literal}{sugar_translate label='LBL_SUPPLIER_ID' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'shipping_address_street_2_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_SHIPPING_ADDRESS_STREET_2' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'billing_address_street_3_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_BILLING_ADDRESS_STREET_3' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'vat_number_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_VAT_NUMBER' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'chemspace_partner_c', 'enum', false,'{/literal}{sugar_translate label='LBL_CHEMSPACE_PARTNER' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'active_customer_c', 'enum', false,'{/literal}{sugar_translate label='LBL_ACTIVE_CUSTOMER' module='Accounts' for_js=true}{literal}' );
...
addToValidate('EditView', 'billing_address_street_2_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_BILLING_ADDRESS_STREET_2' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'cs_contact_id_c', 'int', false,'{/literal}{sugar_translate label='LBL_CS_CONTACT_ID' module='Accounts' for_js=true}{literal}' );
...
addToValidate('EditView', 'company_type_multi_c[]', 'multienum', false,'{/literal}{sugar_translate label='LBL_COMPANY_TYPE_MULTI' module='Accounts' for_js=true}{literal}' );
