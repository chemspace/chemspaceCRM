...
addToValidate('form_QuickCreate_Accounts', 'shipping_address_street_3_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_SHIPPING_ADDRESS_STREET_3' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'supplier_id_c', 'int', false,'{/literal}{sugar_translate label='LBL_SUPPLIER_ID' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'shipping_address_street_2_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_SHIPPING_ADDRESS_STREET_2' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'billing_address_street_3_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_BILLING_ADDRESS_STREET_3' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'vat_number_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_VAT_NUMBER' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'chemspace_partner_c', 'enum', false,'{/literal}{sugar_translate label='LBL_CHEMSPACE_PARTNER' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'active_customer_c', 'enum', false,'{/literal}{sugar_translate label='LBL_ACTIVE_CUSTOMER' module='Accounts' for_js=true}{literal}' );
...
addToValidate('form_QuickCreate_Accounts', 'billing_address_street_2_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_BILLING_ADDRESS_STREET_2' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'cs_contact_id_c', 'int', false,'{/literal}{sugar_translate label='LBL_CS_CONTACT_ID' module='Accounts' for_js=true}{literal}' );
...
addToValidate('form_QuickCreate_Accounts', 'company_type_multi_c[]', 'multienum', false,'{/literal}{sugar_translate label='LBL_COMPANY_TYPE_MULTI' module='Accounts' for_js=true}{literal}' );
