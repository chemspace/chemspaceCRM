...
addToValidate('form_QuickCreate_Contacts', 'company_type_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_COMPANY_TYPE' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'position_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_POSITION' module='Contacts' for_js=true}{literal}' );
...
addToValidate('form_QuickCreate_Contacts', 'role_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_ROLE' module='Contacts' for_js=true}{literal}' );
...
addToValidate('form_QuickCreate_Contacts', 'company_name_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_COMPANY_NAME' module='Contacts' for_js=true}{literal}' );
...
addToValidate('form_QuickCreate_Contacts', 'cs_contact_id_c', 'int', false,'{/literal}{sugar_translate label='LBL_CS_CONTACT_ID' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'ban_reason_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_BAN_REASON' module='Contacts' for_js=true}{literal}' );
...
addToValidate('form_QuickCreate_Contacts', 'reg_ip_c', 'int', false,'{/literal}{sugar_translate label='LBL_REG_IP' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'currency_c', 'enum', false,'{/literal}{sugar_translate label='LBL_CURRENCY' module='Contacts' for_js=true}{literal}' );
