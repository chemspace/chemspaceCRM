...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.customer_company_name_c.hidden}
...
{/if} 
<span class="sugar_field" id="{$fields.customer_company_name_c.name}">{$fields.customer_company_name_c.value}</span>
{/if}
<div class="inlineEditIcon"> {sugar_getimage name="inline_edit_icon.svg" attr='border="0" ' alt="$alt_edit"}</div>
</td>
</tr>
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.enquire_currency_c.hidden}
...
{if is_string($fields.enquire_currency_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.enquire_currency_c.name}" value="{ $fields.enquire_currency_c.options }">
{ $fields.enquire_currency_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.enquire_currency_c.name}" value="{ $fields.enquire_currency_c.value }">
{ $fields.enquire_currency_c.options[$fields.enquire_currency_c.value]}
{/if}
{/if}
<div class="inlineEditIcon"> {sugar_getimage name="inline_edit_icon.svg" attr='border="0" ' alt="$alt_edit"}</div>
</td>
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.enquire_first_name_c.hidden}
...
{/if} 
<span class="sugar_field" id="{$fields.enquire_first_name_c.name}">{$fields.enquire_first_name_c.value}</span>
{/if}
<div class="inlineEditIcon"> {sugar_getimage name="inline_edit_icon.svg" attr='border="0" ' alt="$alt_edit"}</div>
</td>
{counter name="fieldsUsed"}
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.enquire_last_name_c.hidden}
...
{/if} 
<span class="sugar_field" id="{$fields.enquire_last_name_c.name}">{$fields.enquire_last_name_c.value}</span>
{/if}
<div class="inlineEditIcon"> {sugar_getimage name="inline_edit_icon.svg" attr='border="0" ' alt="$alt_edit"}</div>
</td>
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.cs_partner_c.hidden}
...
{if is_string($fields.cs_partner_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.cs_partner_c.name}" value="{ $fields.cs_partner_c.options }">
{ $fields.cs_partner_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.cs_partner_c.name}" value="{ $fields.cs_partner_c.value }">
{ $fields.cs_partner_c.options[$fields.cs_partner_c.value]}
{/if}
{/if}
</td>
</tr>
...
{if is_string($fields.enquire_supplier_id_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.enquire_supplier_id_c.name}" value="{ $fields.enquire_supplier_id_c.options }">
{ $fields.enquire_supplier_id_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.enquire_supplier_id_c.name}" value="{ $fields.enquire_supplier_id_c.value }">
{ $fields.enquire_supplier_id_c.options[$fields.enquire_supplier_id_c.value]}
{/if}
{/if}
<div class="inlineEditIcon"> {sugar_getimage name="inline_edit_icon.svg" attr='border="0" ' alt="$alt_edit"}</div>
</td>
