...
{assign var="value" value=11/05/2015 }
...
{assign var="value" value=11/06/2015 }
...
addToValidate('EditView', 'opportunity_autoincrement_id_c', 'int', false,'{/literal}{sugar_translate label='LBL_OPPORTUNITY_AUTOINCREMENT_ID' module='Opportunities' for_js=true}{literal}' );
