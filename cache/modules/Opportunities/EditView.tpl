...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.cs_partner_c.name}" 
id="{$fields.cs_partner_c.name}" 
title=''       
>
{if isset($fields.cs_partner_c.value) && $fields.cs_partner_c.value != ''}
{html_options options=$fields.cs_partner_c.options selected=$fields.cs_partner_c.value}
{else}
{html_options options=$fields.cs_partner_c.options selected=$fields.cs_partner_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.cs_partner_c.options }
{capture name="field_val"}{$fields.cs_partner_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.cs_partner_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.cs_partner_c.name}" 
id="{$fields.cs_partner_c.name}" 
title=''          
>
{if isset($fields.cs_partner_c.value) && $fields.cs_partner_c.value != ''}
...
<input
id="{$fields.cs_partner_c.name}-input"
name="{$fields.cs_partner_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.cs_partner_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.cs_partner_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.cs_partner_c.name}-input', '{$fields.cs_partner_c.name}');sync_{$fields.cs_partner_c.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
...
{literal}
(function (){
var selectElem = document.getElementById("{/literal}{$fields.cs_partner_c.name}{literal}");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:''};
//get default
...
YUI().use("autocomplete", "autocomplete-filters", "autocomplete-highlighters", "node","node-event-simulate", function (Y) {
{/literal}
SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.cs_partner_c.name}-input');
SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.cs_partner_c.name}-image');
SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.cs_partner_c.name}');
{literal}
function SyncToHidden(selectme){
var selectElem = document.getElementById("{/literal}{$fields.cs_partner_c.name}{literal}");
var doSimulateChange = false;
...
//global variable 
sync_{/literal}{$fields.cs_partner_c.name}{literal} = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("{/literal}{$fields.cs_partner_c.name}{literal}");
...
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.simulate('keyup');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.cs_partner_c.name}-input{literal}'))
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("{/literal}{$fields.cs_partner_c.name}{literal}", syncFromHiddenToWidget);
{/literal}
SUGAR.AutoComplete.{$ac_key}.minQLen = 0;
SUGAR.AutoComplete.{$ac_key}.queryDelay = 0;
SUGAR.AutoComplete.{$ac_key}.numOptions = {$field_options|@count};
...
{assign var="value" value=11/10/2015 }
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.enquire_supplier_id_c.name}" 
id="{$fields.enquire_supplier_id_c.name}" 
title=''       
>
{if isset($fields.enquire_supplier_id_c.value) && $fields.enquire_supplier_id_c.value != ''}
{html_options options=$fields.enquire_supplier_id_c.options selected=$fields.enquire_supplier_id_c.value}
{else}
{html_options options=$fields.enquire_supplier_id_c.options selected=$fields.enquire_supplier_id_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.enquire_supplier_id_c.options }
{capture name="field_val"}{$fields.enquire_supplier_id_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.enquire_supplier_id_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.enquire_supplier_id_c.name}" 
id="{$fields.enquire_supplier_id_c.name}" 
title=''          
>
{if isset($fields.enquire_supplier_id_c.value) && $fields.enquire_supplier_id_c.value != ''}
...
<input
id="{$fields.enquire_supplier_id_c.name}-input"
name="{$fields.enquire_supplier_id_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.enquire_supplier_id_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.enquire_supplier_id_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.enquire_supplier_id_c.name}-input', '{$fields.enquire_supplier_id_c.name}');sync_{$fields.enquire_supplier_id_c.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
...
{literal}
(function (){
var selectElem = document.getElementById("{/literal}{$fields.enquire_supplier_id_c.name}{literal}");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:''};
//get default
...
YUI().use("autocomplete", "autocomplete-filters", "autocomplete-highlighters", "node","node-event-simulate", function (Y) {
{/literal}
SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.enquire_supplier_id_c.name}-input');
SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.enquire_supplier_id_c.name}-image');
SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.enquire_supplier_id_c.name}');
{literal}
function SyncToHidden(selectme){
var selectElem = document.getElementById("{/literal}{$fields.enquire_supplier_id_c.name}{literal}");
var doSimulateChange = false;
...
//global variable 
sync_{/literal}{$fields.enquire_supplier_id_c.name}{literal} = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("{/literal}{$fields.enquire_supplier_id_c.name}{literal}");
...
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.simulate('keyup');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.enquire_supplier_id_c.name}-input{literal}'))
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("{/literal}{$fields.enquire_supplier_id_c.name}{literal}", syncFromHiddenToWidget);
{/literal}
SUGAR.AutoComplete.{$ac_key}.minQLen = 0;
SUGAR.AutoComplete.{$ac_key}.queryDelay = 0;
SUGAR.AutoComplete.{$ac_key}.numOptions = {$field_options|@count};
...
addToValidate('EditView', 'supplier_id_c', 'int', false,'{/literal}{sugar_translate label='LBL_SUPPLIER_ID' module='Opportunities' for_js=true}{literal}' );
...
addToValidate('EditView', 'cs_partner_c', 'enum', false,'{/literal}{sugar_translate label='LBL_CS_PARTNER' module='Opportunities' for_js=true}{literal}' );
