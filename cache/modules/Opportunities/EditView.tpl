...
id='{$fields.opportunity_autoincrement_id_c.name}' size='30' maxlength='255' value='{sugar_number_format precision=0 var=$value}' title='' tabindex='0'   accesskey='7'   >
...
{if strlen($fields.enquire_supplier_id_c.value) <= 0}
{assign var="value" value=$fields.enquire_supplier_id_c.default_value }
{else}
{assign var="value" value=$fields.enquire_supplier_id_c.value }
{/if}  
<input type='text' name='{$fields.enquire_supplier_id_c.name}' 
id='{$fields.enquire_supplier_id_c.name}' size='30' maxlength='255' value='{sugar_number_format precision=0 var=$value}' title='' tabindex='0'    >
...
{/if}  
<input type='text' name='{$fields.enquire_vendor_item_c.name}' 
id='{$fields.enquire_vendor_item_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
...
{/if}  
<input type='text' name='{$fields.enquire_state_c.name}' 
id='{$fields.enquire_state_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</tr>
{/capture}
...
addToValidateRange('EditView', 'opportunity_autoincrement_id_c', 'int', false, '{/literal}{sugar_translate label='LBL_OPPORTUNITY_AUTOINCREMENT_ID' module='Opportunities' for_js=true}{literal}', 1501, 1599);
addToValidate('EditView', 'enquire_supplier_id_c', 'int', false,'{/literal}{sugar_translate label='LBL_ENQUIRE_SUPPLIER_ID' module='Opportunities' for_js=true}{literal}' );
